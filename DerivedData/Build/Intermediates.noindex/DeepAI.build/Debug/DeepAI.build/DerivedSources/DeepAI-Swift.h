...
#ifndef DEEPAI_SWIFT_H
#define DEEPAI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DeepAI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6DeepAI11AppDelegate")
...
@class NSEvent;
SWIFT_CLASS("_TtC6DeepAI15DraggableWindow")
@interface DraggableWindow : NSPanel
